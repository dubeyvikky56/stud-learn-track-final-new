...
import { LayoutDashboard, BookOpen, Award, TrendingUp, LogOut, GraduationCap, Menu, X, User } from 'lucide-react';
            ...
            <div className="mb-3 p-3 bg-white/5 rounded-xl border border-white/10">
              <div className="flex items-center gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-slate-400 truncate">{user?.rollNumber || 'Student'}</p>
                </div>
              </div>
            </div>
          )}
